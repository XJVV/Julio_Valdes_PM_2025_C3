...
void main(void)
{
    ...
    /* Se coloca el 6 como parámetro ya que es la clave de la Ingeniería en computacion. */
}
...

{
    ...
    /*Por cada año se suma el ingreso de los dos semestres de las ocho carreras.*/
    {
        ...
        printf("\nAno con Mayor ingreso del alumno: %d      Alumnos: %d", AO+1, MAY);
}
...

{
    ...
    printf("\n\nAno con mayor ingreso de alumnos: %d        Alumnos: %d", A0+1, MAY);
}
