...
void main(void)
{
    ...
    while(N>MAX || N<1);        /* Se verifica que el tamaño del arreglo válido. */
...
Observa que en el segundo ciclo solamente se recorre la matriz triangular inferior, sin la diagonal pricipal. */
