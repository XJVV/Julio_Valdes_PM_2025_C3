...
if (SUM1 > SUM2)
    if (SUM1 > SUM3)
    {
        printf("\n\nDepartamento con mayores ventas en el último ano: Hilos");
        printf("  Ventas: %.2f", SUM1);
    }
    else
    {
        printf("\n\nDepartamento con mayores ventas en el último ano: Licra");
        printf("  Ventas:%.2f", SUM3);
    }
else
    if (SUM2 > SUM3)
    {
        printf("\n\nDepartamento con mayores ventas en el último ano: Lanas");
