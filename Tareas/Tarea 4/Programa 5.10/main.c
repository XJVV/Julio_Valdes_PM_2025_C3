...
void main(void)
{
    ...
    if (RES)
        ...
        printf("\nEl elemeto no se encuentr en el arreglo");
}

void Lectura(int A[], int T)
/* La función Lectura se utiliza para leer un arreglo unidimensional de T elemetos de tipo entero. */
