...
de precipitación pluvial en los últimos 10 años. Escribe además el registro correspondiente. */

{
    ...
    printf("\n\nProvioncia con mayot registro de lluvia: %d", EMAY+1);
    printf("\nRegistro: %.2f", ELLU);
}
