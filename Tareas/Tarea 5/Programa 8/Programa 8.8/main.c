...
/* Esta función se utiliza para obtener el Numero de pacientes que ingresaron al
hospital en cada una de las categorías de condicion. */
{
...
/* La función F3 se utiliza para generar el nombre y Telefono de todos los
pacientes que tuvieron una condicion de ingreso de máxima gravedad (5). */
{
    int I;
