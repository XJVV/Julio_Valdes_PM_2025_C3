    ...
    while (OPE)
    {
        switch (OPE)
        {
            ...
            case 3: Nuevos_Productos(INV, &TAM);
                /* Se pasa el parámetro por referencia, porque se puede modificar el numero de elementos del arreglo en la función. */
                break;
...
al insertar un producto haya que mover los elementos del arreglo para
...
/* Esta función se utiliza para escribir la informacion almacenada en —el
