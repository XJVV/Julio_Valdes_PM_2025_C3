...
El program, al recibir las coordenadas de los puntos P1, P2 y P3 que
corresponden a los vertices de un triagulo, calcula su perimetro.

X1, Y1, X2, Y2, X3, Y3, LA1, LA2, LA3 y PER: varibles de tipo real. */
